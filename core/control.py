...
class Control(StateManager):
    ...
    def update(self, dt):
        ...
        **Example:**
        ...
        text = basicfont.render('This is a bunch of test data!', True, (255, 255, 255), (0, 0, 0,))
        textrect = text.get_rect()
        textrect.centerx = 450#self.screen.get_rect().centerx
        textrect.centery = 50#self.screen.get_rect().centery
